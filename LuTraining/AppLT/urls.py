...
from .views import buscaClienteDni, buscar, profeFormulario, planFormulario, clienteFormulario, indumentaria, inicio, cliente, planes, profe
...
urlpatterns = [
    ...
    path('busquedaCliente/', buscaClienteDni, name='busquedaCliente'),
